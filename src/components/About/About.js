    ...
    return (
        <section className="about" id="about">
            <div className="about-text">
                ...
                <div class="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="dark" data-type="HORIZONTAL" data-vanity="iamante" data-version="v1"><a class="badge-base__link LI-simple-link" href="https://ph.linkedin.com/in/iamante?trk=profile-badge">James Amante</a></div>
            </div>
